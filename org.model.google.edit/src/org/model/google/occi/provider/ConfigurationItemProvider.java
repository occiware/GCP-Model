...
/**
 * This is the item provider adapter for a {@link org.model.google.occi.Configuration} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
	...
	protected void addLocationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Configuration_location_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Configuration_location_feature", "_UI_Configuration_type"),
				 OcciPackage.Literals.CONFIGURATION__LOCATION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addUsePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Configuration_use_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Configuration_use_feature", "_UI_Configuration_type"),
				 OcciPackage.Literals.CONFIGURATION__USE,
				 true,
				 false,
				 true,
				 null,
