...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Apiendpointhandler</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link appengine.impl.ApiendpointhandlerImpl#getScriptPath <em>Script Path</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ApiendpointhandlerImpl extends ResourceImpl implements Apiendpointhandler {
	/**
	 ...
	 * @generated
	 */
	protected ApiendpointhandlerImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return AppenginePackage.eINSTANCE.getApiendpointhandler();
	}
	...
	public void setScriptPath(String newScriptPath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AppenginePackage.APIENDPOINTHANDLER__SCRIPT_PATH, oldScriptPath, scriptPath));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AppenginePackage.APIENDPOINTHANDLER__SCRIPT_PATH:
