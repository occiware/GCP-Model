 ...
 * </p>
 * <ul>
 *   <li>{@link appengine.impl.arrayImpl#getValues <em>Values</em>}</li>
 * </ul>
 *
 * @generated
 */
public class arrayImpl extends EObjectImpl implements array {
	...
	protected EClass eStaticClass() {
		return AppenginePackage.eINSTANCE.getarray();
	}
	...
	public EList<Object> getValues() {
		if (values == null) {
			values = new EDataTypeEList<Object>(Object.class, this, AppenginePackage.ARRAY__VALUES);
		}
		return values;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AppenginePackage.ARRAY__VALUES:
				return getValues();
		}
