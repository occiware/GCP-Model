...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Api Config Handler Securitylevel</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * Security (HTTPS) enforcement for this URL.
 * <!-- end-model-doc -->
 * @see appengine.AppenginePackage#getApiConfigHandlerSecuritylevel()
 * @model
 * @generated
 */
public enum ApiConfigHandlerSecuritylevel implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Api Config Handler Securitylevel</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final ApiConfigHandlerSecuritylevel[] VALUES_ARRAY =
		new ApiConfigHandlerSecuritylevel[] {
			SECURE_UNSPECIFIED,
			SECURE_DEFAULT,
			SECURE_NEVER,
			SECURE_OPTIONAL,
	...
	/**
	 * A public read-only list of all the '<em><b>Api Config Handler Securitylevel</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<ApiConfigHandlerSecuritylevel> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Api Config Handler Securitylevel</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static ApiConfigHandlerSecuritylevel get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ApiConfigHandlerSecuritylevel result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Api Config Handler Securitylevel</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static ApiConfigHandlerSecuritylevel getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ApiConfigHandlerSecuritylevel result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Api Config Handler Securitylevel</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static ApiConfigHandlerSecuritylevel get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private ApiConfigHandlerSecuritylevel(int value, String name, String literal) {
		this.value = value;
		this.name = name;
