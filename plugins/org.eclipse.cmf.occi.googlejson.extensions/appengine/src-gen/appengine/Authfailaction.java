...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Authfailaction</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * Action to take when users access resources that require authentication. Defaults to redirect.
 * <!-- end-model-doc -->
 * @see appengine.AppenginePackage#getAuthfailaction()
 * @model
 * @generated
 */
public enum Authfailaction implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Authfailaction</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final Authfailaction[] VALUES_ARRAY =
		new Authfailaction[] {
	...
	/**
	 * A public read-only list of all the '<em><b>Authfailaction</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<Authfailaction> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Authfailaction</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static Authfailaction get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			Authfailaction result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Authfailaction</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static Authfailaction getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			Authfailaction result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Authfailaction</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static Authfailaction get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private Authfailaction(int value, String name, String literal) {
		this.value = value;
		this.name = name;
