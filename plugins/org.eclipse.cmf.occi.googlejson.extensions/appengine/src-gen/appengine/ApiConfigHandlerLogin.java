...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Api Config Handler Login</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * Level of login required to access this resource. Defaults to optional.
 * <!-- end-model-doc -->
 * @see appengine.AppenginePackage#getApiConfigHandlerLogin()
 * @model
 * @generated
 */
public enum ApiConfigHandlerLogin implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Api Config Handler Login</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final ApiConfigHandlerLogin[] VALUES_ARRAY =
		new ApiConfigHandlerLogin[] {
			LOGIN_UNSPECIFIED,
			LOGIN_OPTIONAL,
			LOGIN_ADMIN,
			LOGIN_REQUIRED,
	...
	/**
	 * A public read-only list of all the '<em><b>Api Config Handler Login</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<ApiConfigHandlerLogin> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Api Config Handler Login</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static ApiConfigHandlerLogin get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ApiConfigHandlerLogin result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Api Config Handler Login</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static ApiConfigHandlerLogin getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ApiConfigHandlerLogin result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Api Config Handler Login</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static ApiConfigHandlerLogin get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private ApiConfigHandlerLogin(int value, String name, String literal) {
		this.value = value;
		this.name = name;
